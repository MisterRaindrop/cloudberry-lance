...
CREATE USER MAPPING FOR PUBLIC SERVER creds_srv OPTIONS (aws_access_key_id 'LANCE_CANARY_KEY_9f3a', aws_secret_access_key 'LANCE_CANARY_SECRET_9f3a', aws_session_token 'LANCE_CANARY_TOKEN_9f3a');
...
SELECT lance_regress.plan_mentions('SELECT * FROM lance_regress.creds_t',
                                   'VERBOSE, COSTS OFF',
                                   'LANCE_CANARY' || '_TOKEN_9f3a') AS token_in_plan;
